...
export default class R6API {
    ...
    getUserStatus: (query: QueryUUID, options?: IGetUserStatusOptions | undefined) => Promise<{
        userId: string;
    ...
    getProfileApplications: (query: QueryUUID, options?: IGetProfileApplicationsOptions | undefined) => Promise<{
        id: string;
        applications: Omit<{
            id: string;
            name: string | null;
