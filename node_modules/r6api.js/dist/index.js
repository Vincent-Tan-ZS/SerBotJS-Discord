...
class R6API {
    constructor(options) {
        ...
        if (options.ubiAppId)
            auth_1.setUbiAppId(options.ubiAppId);
        if (options.authFileDirPath)
            auth_1.setAuthFileDirPath(options.authFileDirPath);
        if (options.authFileName)
            auth_1.setAuthFileName(options.authFileName);
        if (options.authFilePath)
            auth_1.setAuthFilePath(options.authFilePath);
    }
}
