...
exports.default = async (options) => {
    ...
    const res = await fetch_1.default(utils_1.getURL.NEWS(category, media, locale, fallbackLocale, limit, skip, startIndex))();
    return ({
        ...raw && { raw: res },
        total: res.total,
        limit: res.limit,
        ...
        items: res.items.map(item => ({
            ...
            url: utils_1.getNewsURL(locale, item.type, item.button.buttonUrl),
            date: item.date
        }))
    });
};
