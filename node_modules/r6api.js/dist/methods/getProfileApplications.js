...
exports.default = (ids, options) => auth_1.getToken()
    .then(fetch_1.default(utils_1.getURL.PROFILEAPPLICATIONS(ids)))
    ...
    const applications = options && options.fetchApplications && applicationIds.length
        ? await getApplications_1.default(applicationIds)
        : constants_1.APPLICATIONS;
    return Object.entries(utils_1.groupBy(res.map(application => {
        var _a, _b;
        return ({
