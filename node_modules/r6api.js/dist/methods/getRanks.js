...
exports.default = (platform, ids, options) => {
    ...
    return Promise.all(seasonIds.map(seasonId => Promise.all(regionIds.map(regionId => Promise.all(boardIds.map(boardId => auth_1.getToken()
        .then(fetch_1.default(utils_1.getURL.RANKS(platform, ids, seasonId, regionId, boardId)))))))))
        ...
        Object.entries(players)
            ...
            const currentRankId = boardId !== 'pvp_ranked' ? utils_1.getRankIdFromMmr(val.mmr, matches) : val.rank;
            ...
            acc[id].seasons[seasonId] = acc[id].seasons[seasonId] || {
                ...
                ...constants_1.SEASONS[seasonId] && {
                    ...
                    seasonImage: utils_1.getCDNURL(constants_1.SEASONS[seasonId].imageId, 'jpg'),
            ...
            acc[id].seasons[seasonId].regions[regionId].boards[boardId] = {
                ...
                current: {
                    id: currentRankId,
                    name: utils_1.getRankNameFromRankId(currentRankId, seasonId),
                    mmr: val.mmr,
                    icon: utils_1.getRankIconFromRankId(currentRankId, seasonId)
                },
                max: {
                    id: val.max_rank,
                    name: utils_1.getRankNameFromRankId(val.max_rank, seasonId),
                    mmr: val.max_mmr,
                    icon: utils_1.getRankIconFromRankId(val.max_rank, seasonId)
                },
                lastMatch: {
