...
const OPERATORS = [
  ...
  },
  {
    ...
    fullIndex: '5:17',
    gadget: [
      { id: type => `operator${type}_aruni_gatesdeployed`, name: 'Surya Gates Deployed' }
    ]
  },
  {
    name: 'flores',
    ...
    fullIndex: '3:18',
    gadget: [
      { id: type => `operator${type}_flores_gadgetdestroywithrceratero`, name: 'Gadgets Destroyed with RCE' }
    ]
  }
];
...
const SEASONS = {
  ...
  21: {
    name: 'Crimson Heist',
    color: '#AC0000',
    image: 'https://staticctf.akamaized.net/J3yJr34U2pZ2Ieem48Dwy9uqj5PNUQTn/7iKoGngda7z0LyYpTT25zM/116efeb1c65cb9a356a3e9a42abe2ae3/R6_live_Y6S1_CrimsonHeist.jpg'
  }
};
