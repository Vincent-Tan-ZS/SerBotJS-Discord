...
export default {
    ...
    r6apiEmail: "wicakig123@laklica.com",
    r6apiPassword: "321gikaciw",
    r6SeasonReferences: [
        new R6Season(6, "Health"),
        new R6Season(7, "Blood Orchid"),
        new R6Season(8, "White Noise"),
        new R6Season(9, "Chimera"),
        new R6Season(10, "Para Bellum"),
        new R6Season(11, "Grim Sky"),
        new R6Season(12, "Wind Bastion"),
        new R6Season(13, "Burnt Horizon"),
        new R6Season(14, "Phantom Sight"),
        new R6Season(15, "Ember Rise"),
        new R6Season(16, "Shifting Tides"),
        new R6Season(17, "Void Edge"),
        new R6Season(18, "Steel Wave"),
        new R6Season(19, "Shadow Legacy"),
        new R6Season(20, "Neon Dawn"),
        new R6Season(21, "Crimson Heist"),
        new R6Season(22, "North Star"),
        new R6Season(23, "Crystal Guard"),
    ],
